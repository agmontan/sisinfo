...
class AssistancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assistance" do
    assert_difference('Assistance.count') do
      post assistances_url, params: { assistance: { : @assistance., : @assistance., : @assistance., hours_worked: @assistance.hours_worked, month: @assistance.month, permission: @assistance.permission, user_id: @assistance.user_id } }
    end
  ...
  test "should update assistance" do
    patch assistance_url(@assistance), params: { assistance: { : @assistance., : @assistance., : @assistance., hours_worked: @assistance.hours_worked, month: @assistance.month, permission: @assistance.permission, user_id: @assistance.user_id } }
