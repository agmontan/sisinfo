...
class VouchersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voucher" do
    assert_difference('Voucher.count') do
      post vouchers_url, params: { voucher: { description: @voucher.description, salary: @voucher.salary, user_id: @voucher.user_id } }
    end
  ...
  test "should update voucher" do
    patch voucher_url(@voucher), params: { voucher: { description: @voucher.description, salary: @voucher.salary, user_id: @voucher.user_id } }
